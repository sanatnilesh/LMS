...
<section id="main-content">
          <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> Delete Faculty</h3>
            <div class="row mt">
              <div class="col-lg-12">
                  <div class="form-panel" style="margin:200px; margin-top:10px;">
                      <h1 class="mb"><center> Delete Faculty </center></h1>
                            <!--  <h4>  -->
                      ...
                      <form class="form-horizontal style-form" method="POST">
                          <div class="form-group">
                            ...
                            <input type="text" placeholder="Faculty ID" name="f_id" required="required" class="form-control">
                            </div>
