            ...
            <div class="form-panel" style="margin:200px; margin-top:10px;">
                  ...
                  <div>
                  	<form action="#" method="post">
                        ...
                        <input id="files" style="visibility:hidden;" type="file"></center>
                        <center><input type="submit" name="import" value="Import" class="btn-success"></center>
                        </form>
                      </div>
          						<h3 class="mb"><center>OR</center></h3>
                            <form action="addBook.php" class="form-horizontal style-form" method="post">
                              ...
                              <div class="col-sm-10" style="margin-bottom: 10px;">
                                  <input type="text" name="page" class="form-control" required="required">
                              </div>
                              <label class="col-sm-2 col-sm-2 control-label">Price</label>
                              <div class="col-sm-10" style="margin-bottom: 10px;">
                                  <input type="text" name="price" class="form-control" required="required">
                              </div>
                              <input type="submit" name="submit" value="Add" style="margin-bottom:10px; width: 96%; margin-left:15px;" class="btn btn-success btn-lg btn-block" >
